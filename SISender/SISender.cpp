...
// SISender.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CSISenderApp, CWinApp)
...
BOOL CSISenderApp::InitInstance()
{
//TODO: call AfxInitRichEdit2() to initialize richedit2 library.
	...
	//test
	CString strMsg = _T("");
	strMsg = theApp.m_lpCmdLine;
	//AfxMessageBox(strMsg);
	//인자가 없는 경우는 단독 실행했을 경우가 되므로 이런 경우는 프로그램을 종료하도록 함
	//
